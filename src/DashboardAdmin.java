...
public class DashboardAdmin extends JFrame {
    ...
    private Color accentColor = new Color(231, 76, 60); // Red for admin
    ...
    public DashboardAdmin() {
        ...
        JLabel dashboardLabel = new JLabel("Menu Admin");
        ...
        JLabel welcomeTitle = new JLabel("Tableau de bord Admin");
